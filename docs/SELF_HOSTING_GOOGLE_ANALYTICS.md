...
Connecting Google Analytics lets RANKMYSEO bind a GA4 property to a project. The
...
| ------------ | -------------------------------------------------------- |
| Deployed     | `https://your-rankmyseo-domain.com/api/ga4/oauth/callback` |
...
Set these values and restart RANKMYSEO:
...
RANKMYSEO stores the OAuth tokens encrypted in Better Auth's account table. The
