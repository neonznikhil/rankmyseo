...
Thank you for your interest in contributing to RANKMYSEO!

We deeply appreciate the time and enthusiasm that people bring to the project. One of my favorite things is seeing the forks that people make building off of RANKMYSEO.
...
Additionally, as RANKMYSEO becomes more popular, I'm concerned about malicious contributors attempting to sneak in code that slips through review.
...
```sh
npx skills add rankmyseo/rankmyseo --skill simple-issue-description
```

See [Set up RANKMYSEO Agent Skills](https://rankmyseo.com/docs/skills/setup) for other install options.
...
Here is a link to our Roadmap: http://rankmyseo.com/roadmap
...
If you would like to be more involved, feel free to open an issue on GitHub or reach out via email at nikhiladwaan@gmail.com.
