...
// plugins/rankmyseo/skills/* must be real files, not symlinks to .agents/skills/*.
...
const targetDir = join(repoRoot, "plugins/rankmyseo/skills");
...
console.log(`Synced ${skills.length} skills into plugins/rankmyseo/skills/`);
