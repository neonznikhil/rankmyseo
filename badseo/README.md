...
[RANKMYSEO](https://rankmyseo.com) site audit. Every page lists the audit issues it
should trigger, and a harness runs the real audit engine against a running copy
to check that it does.

Maintained by the team behind [RANKMYSEO](https://rankmyseo.com), an open-source SEO
tool.
...
Every issue type in the RANKMYSEO audit engine is exercised by at least one page
...
The harness drives the **real** RANKMYSEO crawl + issue-detection functions
