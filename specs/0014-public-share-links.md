...
- The public page lives on the app domain and looks like a shared document: a slim bar with the title, "Made with RANKMYSEO", a Share button and a "Try RANKMYSEO" button, with the report filling the rest of the screen in the same sandboxed frame the in-app viewer uses.
