...
// `rankmyseo-<stage>` naming stays comment-synced (and is backstopped by the
...
const WORKER_PREFIX = "rankmyseo";

// The one stage that adopts rankmyseo.com's live hosted resources (unsuffixed
// names, app.rankmyseo.com domain, Postgres). Deliberately not "prod" so a
