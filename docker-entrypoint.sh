...
echo 'RANKMYSEO sends an anonymous usage heartbeat (counts only). Disable: RANKMYSEO_TELEMETRY_DISABLED=1. Details: docs/SELF_HOSTING_DOCKER.md#telemetry'
...
FP_FILE="$OUT_DIR/.rankmyseo-build-env"
