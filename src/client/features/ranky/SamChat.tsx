...
export function SamChat({
  ...
  // RANKY cannot answer a turn without OPENROUTER_API_KEY, so surface setup
    ...
    return (
      <div className="flex h-full min-h-0 flex-col">
        {/* Session title + the shortest path to inspect or correct the shared
            memory RANKY reads and writes during the conversation. */}
    ...
    <div className="flex h-full flex-col items-center justify-center gap-4 p-6 text-center">
      ...
      <div className="space-y-1">
        ...
        <p className="max-w-sm text-sm text-base-content/60">
          RANKY is your in-app SEO agent with access to every RANKMYSEO research
