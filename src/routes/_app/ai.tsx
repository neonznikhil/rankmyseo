...
const DOCS_URL = "https://rankmyseo.com/docs/agent-setup";
const COACH_DOCS_URL = "https://rankmyseo.com/docs/skills/seo-coach";
const SKILLS = [
    ...
    <div className="h-full overflow-auto bg-base-100 px-4 py-12 md:px-6 md:py-16 pb-24 md:pb-12">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-3 text-pretty text-sm leading-relaxed text-base-content/70">
          The most powerful way to use RANKMYSEO is through the AI agent you
            ...
            {getAuthMode(import.meta.env.AUTH_MODE) === "cloudflare_access" ? (
              <div className="alert alert-warning mt-8 text-sm" role="alert">
                ...
                <span>
                  ...
                  application.{" "}
                  <a
                    href="https://rankmyseo.com/docs/self-hosting/cloudflare#connect-the-mcp-server-through-cloudflare-access"
                    target="_blank"
                    rel="noreferrer"
