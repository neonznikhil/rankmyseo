// Every tool result RANKY sees is persisted into the transcript and re-sent to
...
// and it is how long RANKY turns outgrew the Durable Object memory limit in
...
// The MCP server hands external clients the full payload; only RANKY is capped.
