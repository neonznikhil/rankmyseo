...
// One row per RANKY chat session. The conversation history itself lives in the
// RankyChatAgent Durable Object's SQLite (keyed by this id); this table is the
...
export const rankySessions = sqliteTable(
  "ranky_sessions",
  {
  ...
  (table) => [
    ...
    index("ranky_sessions_project_updated_idx").on(
      table.projectId,
      table.updatedAt,
    ),
  ],
