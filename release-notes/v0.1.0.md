...
- Self-hosted anonymous usage telemetry
  - Opt out with `RANKMYSEO_TELEMETRY_DISABLED=1` or `DO_NOT_TRACK=1`.
...
- RANKY chats work again when no custom AI model is configured.

Full Changelog: https://github.com/rankmyseo/rankmyseo/compare/v0.0.28...v0.1.0
