...
> [!NOTE]
> RANKMYSEO now includes agent skills for guided SEO workflows. See [RANKMYSEO Skills](../README.md#rankmyseo-skills) for setup and available skills.

## What's new

- Add RANKMYSEO agent skills for:
  - Keyword Research
  - Keyword Clustering
  - Competitor Analysis
  - Link Prospecting
...
Full Changelog: https://github.com/rankmyseo/rankmyseo/compare/v0.0.14...v0.0.15
