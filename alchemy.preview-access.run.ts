...
//
// This gates the stable stage hostname (`rankmyseo-<stage>.<sub>`). Cloudflare
// version preview URLs (`<version>-rankmyseo-<stage>.<sub>`) sit outside this
...
export default Alchemy.Stack(
  ...
  Effect.gen(function* () {
    ...
    const application = yield* emailAccessGate({
      ...
      policyName: "rankmyseo preview team",
      applicationName: "rankmyseo preview environments",
      domain: hostname,
