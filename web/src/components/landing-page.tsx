...
const PRODUCT_HUNT_URL =
  "https://www.producthunt.com/products/rankmyseo?launch=rankmyseo";
// TODO: update these URLs to your own repo/community.
...
const TESTIMONIALS: Testimonial[] = [
  {
    quote:
      "All of the value, none of the bloat. RANKMYSEO is a no-brainer compared to the expensive alternatives!",
    name: "Fed",
    initial: "F",
    handle: "@foliofed",
  ...
  {
    quote:
      "I've been using RANKMYSEO for the past 3 months, Ben keeps launching features to make it the best. I use it every day to find where my competitors are ranking.",
    name: "Samik",
    initial: "S",
    handle: "Subclip",
  ...
  {
    quote:
      "It's so straightforward and incredibly easy to get started. RANKMYSEO gives you the complete setup, stripped of all the fluff that you get elsewhere.",
    name: "Tom Raine",
    initial: "T",
    handle: "LinkedIn",
  ...
  return (
    <section className="itc-hero">
      <Container>
        ...
        >
          Without quality data, AI gives generic advice. RANKMYSEO is built for
...
function DemoVideo() {
  return (
    <video
      ...
      playsInline
      preload="metadata"
      aria-label="RANKMYSEO product demo: running keyword research"
    >
      <source src="/demo.mp4" type="video/mp4" />
      <img
        src="/demo-poster.webp"
        alt="RANKMYSEO keyword research dashboard"
        width={1280}
        height={966}
        loading="lazy"
        decoding="async"
    ...
    <section className="itc-section itc-section-demo">
      <Container>
        <div className="itc-narrow">
          <h2 className="itc-display-lg">See RANKMYSEO in action</h2>
        ...
        <div className="itc-mcp-grid">
          <div>
            ...
            <p className="itc-body-lg itc-muted" style={{ margin: "20px 0 0" }}>
              ...
              performance, then you can review the work in RANKMYSEO.
            </p>
          ...
          <div className="itc-terminal">
            <div className="itc-terminal-bar">
              ...
              <span className="itc-terminal-label">claude · rankmyseo mcp</span>
            </div>
            <pre>
              <code>
                <span className="t-orange">›</span> find and cluster keywords
                for <span className="t-bright">rankmyseo.com</span>
                {"\n\n"}
                <span className="t-dim">
                  ⏺ rankmyseo.keyword_research(seed: &quot;open source seo&quot;)
                </span>
                {"\n"}
                {"  "}keyword{"                      "}volume{"     "}kd{"\n"}
                {"  "}open source seo{"              "}
                ...
                <span className="t-bright">app.rankmyseo.com/keywords</span>
              </code>
            </pre>
          </div>
        </div>
      ...
      <Container>
        <div className="itc-narrow">
          ...
          <p className="itc-subhead itc-muted" style={{ margin: "20px 0 0" }}>
            ...
            tool from scratch, tell them to build on top of RANKMYSEO.
          </p>
        </div>
  ...
  return (
    <div className="itc">
      ...
      <a
        ...
        aria-label="Join the RANKMYSEO Discord"
      >
        <IconDiscord size={18} />
        <span>Discord</span>
      </a>
