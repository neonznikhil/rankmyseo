...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, in proportion. In RANKMYSEO the cost of a check is the number of keywords times the number of devices times the depth of results inspected, and scheduled checks run through a cheaper queue than one-off live checks. The app shows an estimate before you add keywords or start a run. On the hosted app, rank checks need the $10/month plan, which includes $10 of credits.",
  },
  {
