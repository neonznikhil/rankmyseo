...
const faqs = [
  ...
  {
    question: "Does RANKMYSEO use credits to read Search Console?",
    answer:
      "No. Search Console and URL inspection reads are free in RANKMYSEO, in the app and through the MCP. Rank tracking checks use credits because they fetch live results, and on the hosted app they require the $10/month plan, which includes $10 of credits.",
  },
];
