...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Mobile, unless you know your customers search from desktops. Most queries are mobile-first now and the two result pages differ. RANKMYSEO defaults to mobile and can track both, which doubles the cost of each check.",
  },
  {
  ...
  {
    question: "How much does rank tracking cost in RANKMYSEO?",
    answer:
...
export const Route = createFileRoute("/_marketing/library/rank-tracking/")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Four rank tracking strategies for people who report SEO upward without an SEO budget: pick the keywords, know where Search Console stops, track local positions properly, and write the report that gets read. Each includes a workflow and an RANKMYSEO MCP prompt.",
      path: PATH,
    ...
    <article className="mx-auto max-w-5xl">
      <header className="max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-[var(--color-brand-muted)]">
          ...
          gets read. Each one includes a workflow and a copy-paste RANKMYSEO MCP
          prompt.
        </p>
      </header>
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold tracking-tight text-neutral-950">
          What RANKMYSEO rank tracking checks
        </h2>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]">
