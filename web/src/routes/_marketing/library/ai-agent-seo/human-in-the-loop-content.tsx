...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Two passes. Fact: every number, quote and product claim traces to the brief or the source. Slop: remove the phrases and structures that mark machine writing, such as filler openers, false contrasts and stacked rhetorical questions. RANKMYSEO keeps a catalogue of both in its repository and runs it on every page.",
  },
  {
    question: "Does RANKMYSEO write content?",
    answer:
