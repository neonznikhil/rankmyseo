...
const faqs = [
  {
    ...
    answer:
      "A file, usually SKILL.md, that tells an AI assistant how to do one job: which tools to call in what order, what to check, and what the output should look like. RANKMYSEO ships skills for keyword research, competitor analysis, site audit, local SEO, link prospecting, reporting and project setup, so the assistant runs each workflow the same way every time.",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "A plain-text store it reads before it starts: markdown files of decisions, transcripts and rules, or a structured project context like RANKMYSEO's, which holds goal, positioning, competitors, key pages and a research log. Feedback written into that store becomes a rule; feedback given once in chat is forgotten.",
  },
  {
  ...
  {
    question: "Does RANKMYSEO have project memory?",
    answer:
