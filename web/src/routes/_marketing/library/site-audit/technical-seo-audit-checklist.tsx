...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Partly. Google Search Console reports coverage and indexing for your own verified property at no cost, and it is the more reliable source for anything Google-specific. A crawler adds the on-page and internal-link picture that Search Console does not give you. RANKMYSEO is open source and free to start, with 50-page crawls on the free plan and 10,000-page crawls on the $10/month plan.",
  },
];
