...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The structure on this page is the template, and it is more useful than a formatted document because it tells you what goes in each section and what to leave out. RANKMYSEO can produce every section from a real crawl using the prompt above; it is open source and free to start, with paid plans from $10/month for larger crawls.",
  },
];
