...
export const Route = createFileRoute("/_marketing/library/site-audit/")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Three site audit strategies for turning a crawl into scheduled work: triage by severity, report it so it gets approved, and decide what to delete. Each includes a workflow and an RANKMYSEO MCP prompt.",
      path: PATH,
    ...
    <article className="mx-auto max-w-5xl">
      <header className="max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-[var(--color-brand-muted)]">
          ...
          copy-paste RANKMYSEO MCP prompt.
        </p>
      </header>
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold tracking-tight text-neutral-950">
          What the RANKMYSEO site audit checks
        </h2>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]">
