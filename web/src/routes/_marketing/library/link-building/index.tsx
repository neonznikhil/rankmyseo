...
const faqs = [
  ...
  {
    question: "How does RANKMYSEO help with link building?",
    answer:
...
export const Route = createFileRoute("/_marketing/library/link-building/")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Three link building strategies from practitioners who build links for a living: audit a backlink profile without trusting the score, report referring domains instead of backlinks, and earn links from the pages that already get them. Each includes a workflow and an RANKMYSEO MCP prompt.",
      path: PATH,
...
function LinkBuildingLibraryPage() {
  return (
    <article className="mx-auto max-w-5xl">
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold tracking-tight text-neutral-950">
          What RANKMYSEO backlink analysis shows
        </h2>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]">
