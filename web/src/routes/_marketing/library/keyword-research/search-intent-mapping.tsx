...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Search it. The current top 10 is Google's answer: if it's all listicles, the intent is commercial comparison; all docs and definitions, informational. RANKMYSEO also auto-labels intent on researched keywords in most countries.",
  },
];
