...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The discovery half runs on sources you already have: customer conversations, Google's autocomplete and People Also Ask, and your Search Console. Quality SEO data costs money, which is why the big SEO suites run $100/month and up. You can start RANKMYSEO for free; the paid plan starts at $10/month and includes $10 of usage. If you need more, you can buy top-up credits.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "There is no universal set of three. RANKMYSEO uses four intent types: informational, navigational, commercial, and transactional. By shape, terms are often grouped as head, mid-tail, and long-tail.",
  },
  {
...
export const Route = createFileRoute("/_marketing/library/keyword-research/")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Eight demand-discovery strategies drawn from interviews with working SEOs, each with a workflow and an RANKMYSEO MCP prompt for its data-backed steps.",
      path: PATH,
    ...
    <article className="mx-auto max-w-5xl">
      <header className="max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-[var(--color-brand-muted)]">
          ...
          SEOs, each with a workflow and an RANKMYSEO MCP prompt for its
          data-backed steps.
        </p>
      </header>
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]">
          ...
          >
            RANKMYSEO's keyword research
          </a>{" "}
          and your connected Search Console. RANKMYSEO is open source and
          ...
          $100/month and up; RANKMYSEO's paid plan starts at $10/month and includes
