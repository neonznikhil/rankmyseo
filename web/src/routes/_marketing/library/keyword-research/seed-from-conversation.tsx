...
const faqs = [
  {
    ...
    answer:
      "Conversations for seeds (this page), Google autocomplete + People Also Ask for expansion, Search Console for validation. RANKMYSEO validates and expands what those surface; you can start for free, and paid plans start at $10/month.",
  },
  {
