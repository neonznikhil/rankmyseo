...
export const featurePages = {
  keywordResearch: {
    ...
    imageAlt: "RANKMYSEO keyword research dashboard",
    imageSrc:
    ...
    faqs: [
      {
        question: "What is RANKMYSEO keyword research best for?",
        answer:
          "RANKMYSEO is best for finding SEO keyword ideas, checking demand and difficulty, and turning those ideas into saved keywords you can revisit.",
      },
      {
        question: "Can I use RANKMYSEO as a free keyword research tool?",
        answer:
          "Not unlimited: quality keyword data costs money everywhere, which is why the big SEO suites run $100/month and up. You can start RANKMYSEO for free; the paid plan is $10/month with usage credits included. It's also open source, so you can self-host with your own DataForSEO account.",
      },
      {
        question: "Does RANKMYSEO show live search results?",
        answer:
  ...
  siteAudit: {
    ...
    imageAlt: "RANKMYSEO site audit report",
    imageSrc:
    ...
    faqs: [
      {
        question: "What does the RANKMYSEO site audit tool check?",
        answer:
      ...
      {
        question: "Is RANKMYSEO a free SEO audit tool?",
        answer:
          "For smaller sites, yes: the free plan includes site audits up to 50 pages per crawl. Larger crawls need a paid plan, starting at $10/month. RANKMYSEO is also open source and self-hostable.",
      },
      {
        question: "Who should use RANKMYSEO Site Audit?",
        answer:
  ...
  backlinks: {
    ...
    imageAlt: "RANKMYSEO backlinks report",
    imageSrc:
    ...
    related: [
      ...
      { label: "Domain Overview", href: "/features/domain-overview" },
      { label: "RANKMYSEO MCP", href: "/features/mcp" },
    ],
    faqs: [
      {
      ...
      {
        question: "Can I check competitor backlinks in RANKMYSEO?",
        answer:
  ...
  domainOverview: {
    ...
    imageAlt: "RANKMYSEO domain overview",
    imageSrc:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "RANKMYSEO covers the core of the same report (estimated traffic, organic keywords, top keywords, and top pages) without a triple-digit monthly seat. RANKMYSEO is open source, so you can self-host it, and the managed app is $10/month and includes usage credits.",
      },
      {
        question: "Can RANKMYSEO help with competitor keyword analysis?",
        answer:
  ...
  rankTracking: {
    ...
    imageAlt: "RANKMYSEO rank tracking table",
    imageSrc:
    ...
    differentiators: [
      ...
      "RANKMYSEO can expose ranking data to AI agents through MCP.",
    ],
    related: [
      { label: "Keyword Clustering", href: "/docs/skills/keyword-clustering" },
      {
    ...
    faqs: [
      ...
      {
        question: "Does RANKMYSEO track mobile and desktop rankings?",
        answer:
  ...
  savedKeywords: {
    ...
    imageAlt: "RANKMYSEO saved keywords list",
    imageSrc:
  ...
  aiBrandVisibility: {
    ...
    imageAlt: "RANKMYSEO AI brand visibility report",
    imageSrc:
    ...
    differentiators: [
      ...
      "RANKMYSEO helps teams connect AI mention and citation research to concrete SEO planning.",
    ],
    related: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Traditional SEO focuses on rankings and pages. RANKMYSEO's AI visibility workflow looks at mentions, cited pages, related prompts, and platform-level metrics from supported AI-search sources.",
      },
      {
  ...
  aiSearchPrompts: {
    ...
    imageAlt: "RANKMYSEO prompt explorer",
    imageSrc:
    ...
    differentiators: [
      ...
      "RANKMYSEO treats AI search as a research layer, not a replacement for SEO fundamentals.",
      "RANKMYSEO MCP exposes keyword, SERP, domain, backlink, saved keyword, and rank-tracking tools to AI agents.",
    ],
    related: [
