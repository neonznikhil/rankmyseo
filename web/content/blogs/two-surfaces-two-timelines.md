...
If you want an agent to run the audits below, connect the [RANKMYSEO MCP](/docs/mcp) first so it can pull your live ranking and Search Console data.
...
```
Using the RANKMYSEO MCP, for each of these buyer questions:
  - <question 1>
  - <question 2>
  - <question 3>
