...
![RANKMYSEO keyword research results with the intent column labelling each keyword informational, navigational, commercial or transactional](/library/keyword-research/intent-by-surface-rankmyseo.png)
...
```text
Using the RANKMYSEO MCP, research keywords for "[my topic]" and label
