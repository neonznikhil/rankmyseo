...
![A ranked-keyword list showing 457 estimated organic traffic and 79 organic keywords, where the top rows are all brand terms containing the company's own name](/library/competitive-analysis/brand-dominated-ranked-keywords-rankmyseo.png)
...
```text
Using the RANKMYSEO MCP, run a keyword gap between [mydomain.com]
and [competitor.com].
