...
Set up [RANKMYSEO MCP](/docs/mcp) so your agent can read saved keywords, inspect SERPs, and use RANKMYSEO project context while clustering.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Clustering skill](https://github.com/rankmyseo/rankmyseo/tree/main/.agents/skills/keyword-clustering)
