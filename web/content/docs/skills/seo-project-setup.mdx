...
description: "Interview once and save your site's goals, positioning, competitors, and key pages to your RANKMYSEO project context."
---
...
Your agent asks about the website, goals, positioning, competitors, and key pages once, then saves the answers to your project's context in RANKMYSEO.

Every other skill reads that context, so does RANKY in the app, and you can edit it yourself on the project's Context page, in the sidebar under AI. It carries across sessions, machines, and agents.

## What this skill helps your agent do

- Confirm the right RANKMYSEO project and read what is already saved.
...
- Recommend the next RANKMYSEO Agent Skill to run.
...
## Use it with RANKMYSEO MCP

Set up [RANKMYSEO MCP](/docs/mcp) so your agent can read and write project context and use live SEO data in later workflows. The two context tools are free.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Project Setup skill](https://github.com/rankmyseo/rankmyseo/tree/main/.agents/skills/seo-project-setup)
