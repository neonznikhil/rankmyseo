...
- Help you choose the next RANKMYSEO Agent Skill based on your goal.
- Distinguish strategy questions from execution work.
- Explain when to use RANKMYSEO MCP, saved project context, web search, browser review, or local files.
...
- "What does RANKMYSEO help my agent do?"
...
The coach can help before MCP is connected, but your agent needs [RANKMYSEO MCP](/docs/mcp) for live keyword, SERP, domain, backlink, and saved keyword data.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Coach skill](https://github.com/rankmyseo/rankmyseo/tree/main/.agents/skills/seo-coach)
