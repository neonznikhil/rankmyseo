...
- Ask before saving keywords back to RANKMYSEO.
...
- Confirm before saving selected keywords to RANKMYSEO.

## Use it with RANKMYSEO MCP

Set up [RANKMYSEO MCP](/docs/mcp) so your agent can research live keyword metrics, inspect Google SERPs, check saved keywords, and save selected terms with your approval.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Research skill](https://github.com/rankmyseo/rankmyseo/tree/main/.agents/skills/keyword-research)
