---
title: "Self-Hosting RANKMYSEO"
description: "Run RANKMYSEO yourself with Docker or Cloudflare, bring your own DataForSEO API key, and pay only for what you use."
---

RANKMYSEO is free and open source. Self-hosting means the app costs $0. You bring your own DataForSEO API key and pay DataForSEO directly for API usage.
...
Search Console is optional and works in self-hosted deployments using your own Google OAuth client. It takes about 10 minutes of one-time setup. See the [Google Search Console guide on GitHub](https://github.com/rankmyseo/rankmyseo/blob/main/docs/SELF_HOSTING_GOOGLE_SEARCH_CONSOLE.md).

### AI features (RANKY)

AI features like RANKY, the in-app SEO agent, are optional. Set the `OPENROUTER_API_KEY` environment variable to enable them. Create a key at [openrouter.ai/settings/keys](https://openrouter.ai/settings/keys).
